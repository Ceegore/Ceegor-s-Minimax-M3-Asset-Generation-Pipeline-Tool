...
const SIZE_BUDGETS = new Map([
  ...
  ['renderer/specs/modelSpecs.js', 543], // 360-audit: C-004 subcommand allowlist + capability validation (+16)
  ...
  ['renderer/tabs/imageTab.js', 1110], // 360-audit: C-007 magic-byte admission + grant flow hardening (+14)
