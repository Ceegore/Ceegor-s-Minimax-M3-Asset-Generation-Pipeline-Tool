...
const SIZE_BUDGETS = new Map([
  ...
  ['renderer/tabs/batchImportHelper.js', 1225], // KGO2-004: fenced batch-json import count calculation (+14).
  ['renderer/tabs/batchManager.js', 773], // H9-004/005/013/016/017/018 + H11-1C/3 + X3-01 + B.1: batch-owned grant minting for pure-batch flows. BGR-011/017/023: pipeline spellings + concurrent globals + stale grant (+7). BUG #5: `.actions` selector scoping (+5). gewv2 GEW-009/011: upscaleModel + removeBackgroundUseGpu rowPostprocess fields (+7).
